...
- [0xMagnuz/Bitcoin-v0.1](https://github.com/0xMagnuz/Bitcoin-v0.1) - Original Release of The Bitcoin Source Code (Version 0.1) by Satoshi Nakamoto
...
- [andmoredev/agentcore-starter](https://github.com/andmoredev/agentcore-starter) - 
...
- [pb-/gmail-mbox-codec](https://github.com/pb-/gmail-mbox-codec) - A tiny script to enable efficient incremental file-based backups from Gmail takeouts.
...
- [p-e-w/shin](https://github.com/p-e-w/shin) - A shell in every text input on your system
...
- [nathants/git-remote-aws](https://github.com/nathants/git-remote-aws) - encrypted git on s3
...
- [0xwilliamortiz/claude-red](https://github.com/0xwilliamortiz/claude-red) - claude-red is a curated library of offensive security skills designed for the Claude skills system. Each skill is a structured SKILL.md file that primes Claude with expert-level methodology for a spec
...
- [open-energy-transition/Awesome-Electrical-Grid-Mapping](https://github.com/open-energy-transition/Awesome-Electrical-Grid-Mapping) - A curated dataset of global electrical grid maps, datasets and resources.
...
- [janwilmake/efficient-recorder](https://github.com/janwilmake/efficient-recorder) - Attempt to create an Open Source Privacy Focused Rewind.ai Alternative
...
- [AlexAllocated/shotgun](https://github.com/AlexAllocated/shotgun) - A simple UI agnostic command framework.
...
- [thomasfricke/training-kubernetes-security](https://github.com/thomasfricke/training-kubernetes-security) - 
...
- [SimonSchubert/Braincup](https://github.com/SimonSchubert/Braincup) - Memory, focus & math trainer
...
- [EvanThomasLuke/Awesome-AI-Hacking-Agents](https://github.com/EvanThomasLuke/Awesome-AI-Hacking-Agents) - List of AI Hacking Agents
...
- [jacoblindqvist/obsidian-pubit](https://github.com/jacoblindqvist/obsidian-pubit) - Obsidian plugin for PubIt - Publish your notes to the web with zero friction
...
- [vidanov/video](https://github.com/vidanov/video) - Test videofiles, links and other random infos about the modern video production
...
- [fehlfarbe/diy-bike-trailer](https://github.com/fehlfarbe/diy-bike-trailer) - 
...
- [tsmith/node-control](https://github.com/tsmith/node-control) - Permanently archived project
...
- [61418/elhaz](https://github.com/61418/elhaz) - A local daemon-backed AWS temporary credential broker, exposed over a Unix socket and controlled via CLI.
...
- [Q00/ouroboros](https://github.com/Q00/ouroboros) - Agent OS: Stop prompting. Start specifying. A Socratic interview gates the spec on an ambiguity score, then one command drives execution, a 3-stage evaluation gate, and a budgeted evolution loop. MCP 
...
- [DataDog/pathfinding.cloud](https://github.com/DataDog/pathfinding.cloud) - An AWS IAM Privilege Escalation Path Library
...
- [jayin92/Skyfall-GS](https://github.com/jayin92/Skyfall-GS) - [ECCV 2026] Skyfall-GS: Synthesizing Immersive 3D Urban Scenes from Satellite Imagery
...
- [lotus-data/lotus](https://github.com/lotus-data/lotus) - Optimized Agentic and LLM Bulk Processing Over Your Data
...
- [rschroll/rmcl](https://github.com/rschroll/rmcl) - reMarkable Cloud Library for Python
...
- [Cryptonite-MIT/Write-ups](https://github.com/Cryptonite-MIT/Write-ups) - Cryptonite is the official ethical hacking and cybersecurity team of Manipal Institute of Technology. At Cryptonite, our areas of focus are cryptography, forensics, research, reverse engineering and w
...
- [isaacvando/rtl](https://github.com/isaacvando/rtl) - A template language for Roc with compile time validation and tag unions
...
- [wojtczyk/trust](https://github.com/wojtczyk/trust) - TRUST – Coding Rust like it's 1989
...
- [krzysckh/nienor](https://github.com/krzysckh/nienor) - optimizing compiler for a lisp dialect targetting uxn vm
...
- [smaskalik/sqsmover](https://github.com/smaskalik/sqsmover) - AWS SQS Message mover
...
- [redwoodjs/machinen.dev](https://github.com/redwoodjs/machinen.dev) - Pause, resume, fork Linux VMs across hosts
...
- [Pantheon-Security/notebooklm-mcp-secure](https://github.com/Pantheon-Security/notebooklm-mcp-secure) - Secure NotebookLM MCP Server - Query Google NotebookLM from Claude/AI agents with 17 security hardening layers
...
- [jonelantha/react-responsive-pagination](https://github.com/jonelantha/react-responsive-pagination) - A React pagination component which intelligently renders to the available width - plenty of styling options
...
- [Shopify/quilt](https://github.com/Shopify/quilt) - [⚠️ Deprecated] A loosely related set of packages for JavaScript/TypeScript projects at Shopify
...
- [PreciousChicken/vim-groff-viewer](https://github.com/PreciousChicken/vim-groff-viewer) - A vim plugin for displaying Groff files in a document viewer.
